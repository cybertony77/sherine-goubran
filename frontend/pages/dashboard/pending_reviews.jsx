  ...
  return (
    <div className={styles.page}>
      <div className={styles.wrap}>
        <Title href="/dashboard/public_reviews" backText="Back">
        ...
        <div className={styles.card}>
          <div className={styles.cardHeader}>
            <div>
              ...
              <p>Approve or reject reviews submitted from public pages</p>
            </div>
          </div>
                  ...
                  <div className={styles.itemMain}>
                    <div className={styles.itemTop}>
                      <h4 className={styles.itemTitle}>
                        ...
                        <span className={styles.itemCategory}>{review.category}</span>
                        <span className={styles.itemDot} aria-hidden="true">
                          •
                        </span>
                      ...
                      <div className={styles.itemTags}>
                        ...
                        {review.public_slug ? (
                          <span className={styles.slugBadge}>/{review.public_slug}</span>
                        ) : null}
                      </div>
                    </div>
