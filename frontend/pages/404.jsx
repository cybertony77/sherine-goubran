  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        borderRadius: "24px",
        padding: "60px 40px",
        boxShadow: "0 25px 80px rgba(15, 15, 16, 0.25)",
        ...
        <style jsx>{`
          ...
          .error-code {
            font-size: 8rem;
            font-weight: 900;
            background: linear-gradient(90deg, #8A8A8A 0%, #C9A96A 50%, #0F0F10 100%);
          ...
          .btn-primary {
            background: linear-gradient(135deg, #C9A96A 0%, #B8954F 100%);
            color: #0F0F10;
          ...
          .btn-primary:hover {
            ...
            box-shadow: 0 12px 35px rgba(201, 169, 106, 0.5);
          }
          
          .btn-secondary {
            background: linear-gradient(135deg, #2B2B2B 0%, #0F0F10 100%);
            color: #F7F4EE;
            box-shadow: 0 8px 25px rgba(15, 15, 16, 0.35);
          }
          
          .btn-secondary:hover {
            transform: translateY(-3px);
            box-shadow: 0 12px 35px rgba(15, 15, 16, 0.45);
          }
          
          .btn-contact {
            background: linear-gradient(135deg, #C9A96A 0%, #E9DDD0 100%);
            color: #0F0F10;
            box-shadow: 0 8px 25px rgba(201, 169, 106, 0.35);
          }
          
          .btn-contact:hover {
            transform: translateY(-3px);
            box-shadow: 0 12px 35px rgba(201, 169, 106, 0.45);
          }
