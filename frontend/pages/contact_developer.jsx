        ...
        <div style={{
          ...
          <div className="loading-container">
            ...
            <div style={{
              ...
              boxShadow: "0 8px 24px rgba(201, 169, 106,0.15)",
              background: "#E9DDD0",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            ...
            <div style={{
              width: "50px",
              height: "50px",
              border: "4px solid rgba(201, 169, 106, 0.2)",
      ...
      <div style={{ 
        ...
        {hasToken && (
          <Title backText="Back" href={null}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <Image src="/message2.svg" alt="Message" width={32} height={32} />
              Contact Developer
            </div>
          </Title>
        )}
        ...
        <div className="contact-card-container">
          <style jsx>{`
            ...
            .contact-item {
              background: linear-gradient(135deg, rgba(201, 169, 106, 0.1) 0%, rgba(254, 185, 84, 0.1) 100%);
            ...
            <div className="contact-item">
              ...
              <div>
                <a 
                  ...
                  className="contact-link"
                  style={{ color: "var(--system-secondary)" }}
                >
                  <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <>
                ...
                <button 
                  ...
                  style={{
                    ...
                    justifyContent: "center",
                    cursor: "pointer",
                    boxShadow: "0 4px 16px rgba(201, 169, 106, 0.3)",
                    transition: "all 0.3s ease",
                    fontSize: "1.1rem",
                    color: "white",
                    fontWeight: "600",
                  ...
                  onMouseEnter={(e) => {
                    e.target.style.transform = "translateY(-2px)";
                    e.target.style.boxShadow = "0 6px 20px rgba(201, 169, 106, 0.4)";
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = "translateY(0)";
                    e.target.style.boxShadow = "0 4px 16px rgba(201, 169, 106, 0.3)";
                  }}
                >
