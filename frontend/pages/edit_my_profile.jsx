      ...
      <div style={{ maxWidth: 600, margin: "40px auto", padding: "20px 5px 20px 5px" }}>
        <style jsx>{`
          ...
          .submit-btn {
            width: 100%;
            padding: 16px;
            background: linear-gradient(135deg, #C9A96A 0%, #E9DDD0 100%);
            color: #0F0F10;
            border: none;
            border-radius: 10px;
            font-size: 1.1rem;
          ...
          .submit-btn:disabled {
            ...
            cursor: not-allowed;
            transform: none;
            box-shadow: 0 2px 8px rgba(201, 169, 106, 0.2);
          }
          .success-message {
          ...
          .no-changes {
            background: linear-gradient(135deg, #8A8A8A 0%, #2B2B2B 100%);
            color: #0F0F10;
            border-radius: 10px;
            padding: 12px 16px;
            margin-bottom: 16px;
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-group" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isDragging ? '0 4px 16px rgba(201, 169, 106,0.4)' : '0 2px 8px rgba(201, 169, 106,0.15)',
                      border: isDragging ? '3px dashed var(--system-secondary)' : '2px solid var(--system-secondary)',
                      overflow: 'hidden',
                      position: 'relative',
                ...
                <label
                  ...
                  style={{
                    ...
                    background: uploadingImage 
                      ? 'linear-gradient(135deg, #8A8A8A 0%, #2B2B2B 100%)' 
                      : isDragging
                      ? 'linear-gradient(135deg, var(--system-secondary) 0%, #C9A96A 100%)'
                      : 'linear-gradient(135deg, #C9A96A 0%, #E9DDD0 100%)',
                    color: 'white',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    ...
                    textAlign: 'center',
                    transition: 'all 0.3s ease',
                    boxShadow: isDragging ? '0 6px 20px rgba(201, 169, 106, 0.5)' : '0 4px 12px rgba(201, 169, 106, 0.3)',
                    opacity: uploadingImage ? 0.7 : 1,
                    border: isDragging ? '3px dashed white' : '2px solid var(--system-secondary)',
              ...
              <input
                ...
                style={{ display: 'none' }}
              />
              <small style={{ color: '#8A8A8A', fontSize: '0.85rem', textAlign: 'center', marginTop: '4px' }}>
            ...
            <div className="form-group">
              ...
              {form.password && form.password.trim() !== "" && (
                <small style={{ color: '#8A8A8A', fontSize: '0.85rem', marginTop: '4px', display: 'block' }}>
