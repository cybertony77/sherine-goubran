    ...
    try {
      const emailHTML = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0F0F10; padding: 0;">
          <div style="height: 6px; background: linear-gradient(90deg, #A8894A 0%, #C9A96A 35%, #E9DDD0 50%, #C9A96A 65%, #A8894A 100%);"></div>
          <div style="padding: 40px 30px; background-color: #0F0F10;">
            ...
            <p style="color: #F7F4EE; font-size: 16px; margin: 0 0 20px 0;">Hi ${userName},</p>
            <p style="color: #F7F4EE; font-size: 16px; margin: 0 0 30px 0;">To reset your password, please use this OTP code:</p>
            <div style="background-color: #1A1A1B; padding: 22px; border-radius: 12px; margin: 20px 0; text-align: center; border: 1px solid #C9A96A;">
              <div style="color: #C9A96A; font-size: 32px; font-weight: bold; letter-spacing: 6px; font-family: Arial, sans-serif;">${otpCode}</div>
            </div>
            <p style="color: #F7F4EE; font-size: 16px; margin: 20px 0;">This code is valid for <strong style="color: #C9A96A;">10 minutes</strong>. Please do not share this code with anyone.</p>
            <p style="color: #8A8A8A; font-size: 15px; margin: 30px 0 0 0;">If you didn't request this, please ignore this email or contact our <a href="${SYSTEM_DOMAIN}/contact_developer" style="color: #C9A96A; text-decoration: underline;">developer</a>.</p>
            <p style="color: #F7F4EE; font-size: 16px; margin: 30px 0 0 0;">Best regards,</p>
            <p style="color: #E9DDD0; font-size: 16px; margin: 5px 0 0 0;">Support Team</p>
          </div>
          <div style="border-top: 1px solid rgba(201, 169, 106, 0.35); padding: 30px; background-color: #0F0F10;">
            ...
            <div style="font-size: 14px; margin-bottom: 0; text-align: center;">
              <a href="${SYSTEM_DOMAIN}" style="color: #E9DDD0; text-decoration: underline;">${SYSTEM_DOMAIN.replace(/^https?:\/\//, '')}</a>
            </div>
          </div>
          <div style="border-top: 1px solid rgba(201, 169, 106, 0.2); padding: 15px 30px; background-color: #1A1A1B;">
