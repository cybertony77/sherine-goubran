      ...
      <div ref={containerRef} style={{ maxWidth: 800, margin: "40px auto", padding: "12px" }}>
              ...
              <Table striped highlightOnHover withTableBorder withColumnBorders>
                <Table.Thead style={{ position: 'sticky', top: 0, backgroundColor: '#f8f9fa' }}>
                  <Table.Tr>
                    ...
                    <Table.Th style={{ width: '22%', textAlign: 'center' }}>Email</Table.Th>
                    <Table.Th style={{ width: '16%', textAlign: 'center' }}>Role</Table.Th>
                    <Table.Th style={{ width: '16%', textAlign: 'center' }}>Account Status</Table.Th>
                  </Table.Tr>
                </Table.Thead>
                <Table.Tbody>
                  {assistants.map(assistant => (
                    <Table.Tr key={assistant.id}>
                      <Table.Td style={{ fontWeight: 'bold', color: 'var(--system-secondary)', textAlign: 'center' }}>{assistant.id}</Table.Td>
                      ...
                      <Table.Td style={{ 
                        fontSize: '0.9rem', 
                        textAlign: 'center', 
                        color: assistant.email ? '#2B2B2B' : '#8A8A8A',
                        wordWrap: 'break-word',
                      ...
                      <Table.Td style={{ 
                        fontWeight: '600',
                        color: assistant.role === 'admin' ? '#dc3545' : (assistant.role === 'developer' ? '#28a745' : (assistant.role === 'assistant' ? '#3175b1' : '#8A8A8A')),
                        textAlign: 'center'
        ...
        <style jsx>{`
          ...
          .pagination-button {
            ...
            font-weight: 600;
            box-shadow: 0 2px 8px rgba(201, 169, 106, 0.1);
          }
          ...
          .page-number-btn:hover {
            ...
            border-color: var(--system-secondary);
            transform: translateY(-2px);
            box-shadow: 0 4px 8px rgba(201, 169, 106, 0.3);
          }
