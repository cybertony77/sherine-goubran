...
export default function AddAssistant() {
  ...
  const [form, setForm] = useState({ id: "", name: "", phone: "", email: "", password: "", role: "assistant", account_state: "Activated" });
  ...
  const handleSubmit = async (e) => {
    ...
    createAssistantMutation.mutate(payload, {
      onSuccess: (data) => {
        setSuccess(true);
        setForm({ id: "", name: "", phone: "", email: "", password: "", role: "assistant", account_state: "Activated" });
        setConfirmPassword("");
