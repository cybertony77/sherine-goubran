...
export default function EditAssistant() {
  ...
  const [form, setForm] = useState({ id: "", name: "", phone: "", email: "", password: "", role: "", account_state: "Activated" });
  ...
  const handleIdChange = (e) => {
    ...
    if (!value.trim()) {
      const emptyForm = { id: "", name: "", phone: "", password: "", role: "assistant", account_state: "Activated" };
      setForm(emptyForm);
            ...
            {showSearchResults && searchResults.length > 0 && (
              <div style={{ 
                ...
                {searchResults.map((assistant) => (
                  ...
                  >
                    <div style={{ fontWeight: "600", color: "var(--system-secondary)" }}>
