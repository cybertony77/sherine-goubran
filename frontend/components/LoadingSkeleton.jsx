    ...
    <div className="skeleton-table">
      <style jsx>{`
        ...
        .skeleton-title {
          ...
          margin-bottom: 28px;
          position: relative;
          box-shadow: 0 4px 12px rgba(201, 169, 106, 0.1);
        }
...
rgb(165, 175, 179) 100%
          ...
          box-shadow: 0 4px 12px rgba(201, 169, 106, 0.2);
        }
    ...
    <div className="skeleton-card">
      <style jsx>{`
        ...
        .skeleton-card-title {
          ...
          border-radius: 16px;
          margin-bottom: 36px;
          box-shadow: 0 4px 16px rgba(201, 169, 106, 0.12);
        }
        ...
        .skeleton-button {
          ...
          background: linear-gradient(
            ...
            #87CEEB 25%,
            var(--system-secondary) 50%,
            #87CEEB 75%,
            var(--system-secondary) 100%
          );
          background-size: 300% 100%;
          animation: buttonShimmer 2.5s ease-in-out infinite;
          border-radius: 16px;
          margin-top: 24px;
          box-shadow: 0 6px 20px rgba(201, 169, 106, 0.2);
        }
    ...
    <div className="skeleton-list">
      <style jsx>{`
        ...
        .skeleton-avatar {
          ...
          box-shadow: 0 6px 16px rgba(201, 169, 106, 0.2);
          position: relative;
        }
        ...
        .skeleton-name {
          ...
          border-radius: 10px;
          margin-bottom: 10px;
          box-shadow: 0 2px 8px rgba(201, 169, 106, 0.08);
        }
