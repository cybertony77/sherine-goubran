...
export default function ImportExistingOnlineItemModal({
  ...
  const accent = 'var(--system-secondary)';
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              background: 'linear-gradient(135deg, var(--system-surface) 0%, #eef2ff 100%)',
            ...
            >
              <div
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: '0 2px 8px rgba(201, 169, 106, 0.15)',
                }}
              >
              ...
              <div style={{ position: 'relative', width: '100%' }}>
                <div
                  ...
                  style={{
                    ...
                    boxShadow: dropdownOpen ? `0 0 0 3px rgba(201, 169, 106, 0.1)` : 'none',
                    minHeight: '52px',
                  }}
                  onClick={(e) => {
                    e.stopPropagation();
          ...
          >
            <button
              ...
              style={{
                ...
                minWidth: '120px',
                boxShadow:
                  !hasOptions || !selectedValue || applyLoading ? 'none' : '0 4px 14px rgba(201, 169, 106, 0.35)',
              }}
            >
