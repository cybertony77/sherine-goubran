  ...
  return (
    ...
    >
      <div style={{ marginBottom: 24, padding: 18, borderRadius: 14, background: 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%)', border: '1.5px solid #bae6fd', textAlign: 'center' }}>
        ...
        <button type="button" onClick={() => { setImportSelectedId(''); setImportModalOpen(true); }} style={{ padding: '12px 20px', borderRadius: 10, border: 'none', background: 'linear-gradient(135deg, var(--system-secondary) 0%, #0284c7 100%)', color: '#fff', fontWeight: 700, cursor: 'pointer' }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ display: 'flex', gap: 8, borderBottom: '2px solid #e9ecef', marginBottom: 20 }}>
          <button type="button" style={{ padding: '12px 24px', border: 'none', borderBottom: '3px solid var(--system-secondary)', background: 'transparent', color: 'var(--system-secondary)', fontWeight: 600 }}>PDF</button>
        </div>
        <div style={{ padding: 20, border: '2px solid #e9ecef', borderRadius: 12, backgroundColor: '#f8f9fa' }}>
          ...
          <div>
            ...
            {pdfUploading && (
              <div style={{ border: '2px solid var(--system-secondary)', borderRadius: 8, padding: 20, backgroundColor: '#fff' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}><span>Uploading PDF...</span><span>{pdfProgress}%</span></div>
                <div style={{ width: '100%', height: 8, backgroundColor: '#e9ecef', borderRadius: 4 }}><div style={{ width: `${pdfProgress}%`, height: '100%', backgroundColor: 'var(--system-secondary)', borderRadius: 4 }} /></div>
              </div>
            )}
