    ...
    <>
      <style jsx>{`
        ...
        .spinner {
          ...
          border-top: 4px solid var(--system-secondary);
          border-radius: 50%;
        ...
        .qr-container-modal {
          ...
          align-items: center;
          justify-content: center;
           background: var(--system-page-bg, linear-gradient(380deg, var(--system-secondary) 0%, #FEB954 100%));
          padding: 24px;
        ...
        .download-btn {
          background: linear-gradient(135deg, var(--system-secondary) 0%, #0ea5e9 42%, #feb954 160%);
          box-shadow:
            0 12px 28px rgba(201, 169, 106, 0.35),
        ...
        .download-btn:hover:not(:disabled) {
          ...
          box-shadow: 0 16px 32px rgba(201, 169, 106, 0.42);
        }
