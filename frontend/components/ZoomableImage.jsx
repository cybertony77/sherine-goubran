...
const TEAL = 'var(--system-secondary)';
const TEAL_MUTED = 'rgba(201, 169, 106, 0.35)';
const TEAL_SOFT_BG = 'rgba(201, 169, 106, 0.1)';
const TEAL_BORDER = 'rgba(201, 169, 106, 0.5)';
...
const zoomBtnEnabled = (disabled) => ({
  ...
  fontWeight: '600',
  boxShadow: disabled ? 'none' : '0 2px 4px rgba(201, 169, 106, 0.12)',
});
      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            gap: '12px',
            padding: '12px 16px',
            background: 'linear-gradient(135deg, var(--system-secondary) 0%, #0d5a7a 100%)',
