    ...
    <TextInput
      ...
      styles={{
        input: {
          ...
          background: 'linear-gradient(145deg, #ffffff, var(--system-surface))',
          fontWeight: 600,
          '&:focus': {
            borderColor: 'var(--system-secondary)',
          },
        },
      }}
      {...props}
    ...
    <div
      ...
      style={{
        ...
        background: error
          ...
          : 'linear-gradient(135deg, rgba(201, 169, 106,0.45), rgba(254,185,84,0.4) 55%, rgba(14,165,233,0.35))',
        boxShadow: error
          ? '0 12px 32px rgba(220, 53, 69, 0.16)'
          : '0 12px 32px rgba(201, 169, 106, 0.1)',
      }}
    >
      <div
        ...
        style={{
          borderRadius: 15,
          background: 'linear-gradient(165deg, #ffffff 0%, var(--system-surface) 100%)',
          overflow: 'visible',
        }}
      >
        <div
          ...
          style={{
            padding: '16px 18px',
            background: 'linear-gradient(120deg, rgba(201, 169, 106,0.12), rgba(254,185,84,0.1))',
            ...
            {selectedIds.map((id) => (
              <button
                ...
                style={{
                  ...
                  fontSize: '0.8rem',
                  cursor: 'pointer',
                  boxShadow: '0 4px 10px rgba(201, 169, 106, 0.1)',
        ...
        <div className="cert-students-body" style={{ padding: 16, display: 'grid', gap: 14, overflow: 'visible' }}>
          ...
          <div
            ...
            style={{
              ...
              overflowY: 'auto',
              borderRadius: 14,
              border: '1.5px solid rgba(201, 169, 106, 0.2)',
              background: '#fff',
                ...
                return (
                  <label
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      background: checked
                        ? 'linear-gradient(90deg, rgba(201, 169, 106,0.12), rgba(254,185,84,0.06))'
                        : 'transparent',
                      borderLeft: checked ? '3px solid var(--system-secondary)' : '3px solid transparent',
            ...
            >
              <button
                ...
                style={{
                  ...
                  background: pagination.hasPrevPage
                    ? 'linear-gradient(135deg, var(--system-secondary), #0ea5e9)'
                    : '#ced4da',
                  color: '#fff',
                  fontWeight: 800,
                  cursor: pagination.hasPrevPage ? 'pointer' : 'not-allowed',
                  boxShadow: pagination.hasPrevPage ? '0 8px 16px rgba(201, 169, 106, 0.25)' : 'none',
                }}
              >
                Previous
              </button>
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: pagination.hasNextPage ? '0 8px 16px rgba(201, 169, 106, 0.25)' : 'none',
                }}
              >
                Next
              </button>
