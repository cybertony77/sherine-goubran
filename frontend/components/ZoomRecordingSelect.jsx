  ...
  return (
    <div style={{ marginTop: '10px' }}>
      ...
      <div
        ...
        style={{
          padding: '12px 14px',
          border: isOpen ? '2px solid var(--system-secondary)' : '1px solid #dfe6ee',
          borderRadius: '10px',
          background: isOpen ? '#eef8ff' : '#fff',
          cursor: 'pointer',
          fontWeight: selectedValue ? 600 : 500,
          color: selectedValue ? 'var(--system-secondary)' : '#777',
                ...
                >
                  <span
                    style={{
                      ...
                      borderTopColor: 'var(--system-secondary)',
                      borderRadius: '50%',
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        color: isSelected ? 'var(--system-secondary)' : '#111827',
