  ...
  return (
    <div style={{ position: 'relative', width: '100%' }} ref={dropdownRef}>
      <div
        style={{
          padding: '14px 16px',
          border: isDropdownOpen ? '2px solid var(--system-secondary)' : '2px solid #e9ecef',
          borderRadius: '10px',
          ...
          alignItems: 'center',
          fontSize: '1rem',
          color: selectedMockExam ? 'var(--system-secondary)' : '#adb5bd',
          backgroundColor: selectedMockExam ? '#f0f8ff' : '#ffffff',
          fontWeight: selectedMockExam ? '600' : '400',
          transition: 'all 0.3s ease',
          boxShadow: isDropdownOpen ? '0 0 0 3px rgba(201, 169, 106, 0.1)' : 'none'
        }}
          ...
          {examOptions.map((exam) => (
            <div
              ...
              style={{
                ...
                borderBottom: '1px solid #f8f9fa',
                transition: 'background-color 0.2s ease',
                color: selectedMockExam === exam ? 'var(--system-secondary)' : '#000000',
