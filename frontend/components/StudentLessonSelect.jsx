  ...
  return (
    <div ref={dropdownRef} style={{ position: 'relative', width: '100%' }}>
      <div
        style={{
          padding: '14px 16px',
          border: isOpen ? '2px solid var(--system-secondary)' : '2px solid #e9ecef',
          borderRadius: '10px',
          ...
          alignItems: 'center',
          fontSize: '1rem',
          color: selectedLesson && selectedLesson !== 'n/a' ? 'var(--system-secondary)' : '#adb5bd',
          backgroundColor: selectedLesson && selectedLesson !== 'n/a' ? '#f0f8ff' : '#ffffff',
          fontWeight: selectedLesson && selectedLesson !== 'n/a' ? '600' : '400',
          transition: 'all 0.3s ease',
          boxShadow: isOpen ? '0 0 0 3px rgba(201, 169, 106, 0.1)' : 'none'
        }}
        onClick={onToggle}
      >
            ...
            availableLessons.map((lesson) => (
              <div
                ...
                style={{
                  ...
                  borderBottom: '1px solid #f8f9fa',
                  transition: 'background-color 0.2s ease',
                  color: selectedLesson === lesson ? 'var(--system-secondary)' : '#000000',
