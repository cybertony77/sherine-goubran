      ...
      <>
        ...
        <style jsx>{`
          .subscription-card {
            ...
            border-radius: 20px;
            padding: 6px;
            box-shadow: 0 10px 40px rgba(15, 15, 16, 0.35);
            margin: 30px 0;
            overflow: hidden;
          ...
          .subscription-card::before {
            ...
            background: conic-gradient(
              from 0deg,
              var(--system-secondary) 0deg 90deg,
              transparent 90deg 180deg,
              var(--system-secondary-hover) 180deg 270deg,
          ...
          .loading-box {
            ...
            align-items: center;
            justify-content: center;
            background: linear-gradient(135deg, rgba(201, 169, 106, 0.08) 0%, rgba(15, 15, 16, 0.04) 100%);
            border: 2px solid rgba(201, 169, 106, 0.28);
            border-radius: 16px;
            padding: 40px 30px;
            box-shadow: 0 8px 24px rgba(201, 169, 106, 0.15);
            max-width: 400px;
            width: 100%;
          }
          ...
          .spinner {
            width: 60px;
            height: 60px;
            border: 5px solid rgba(201, 169, 106, 0.1);
            border-top: 5px solid var(--system-secondary);
            border-right: 5px solid var(--system-secondary-hover);
            border-radius: 50%;
          ...
          .spinner::before {
            ...
            border-top: 3px solid var(--system-secondary);
            border-radius: 50%;
            ...
            {timeRemaining && (
              <div className="subscription-timer">
                ...
                <div className="timer-value">
                  <span className="timer-num">{String(timeRemaining.days).padStart(2, '0')}</span>
                  <span className="timer-unit"> days : </span>
                  <span className="timer-num">{String(timeRemaining.hours).padStart(2, '0')}</span>
                  <span className="timer-unit"> hours : </span>
                  <span className="timer-num">{String(timeRemaining.minutes).padStart(2, '0')}</span>
                  <span className="timer-unit"> min : </span>
                  <span className="timer-num">{String(timeRemaining.seconds).padStart(2, '0')}</span>
