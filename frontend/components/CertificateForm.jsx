        ...
        <input
          ...
          onFocus={(e) => {
            if (!errors.certificate_name) {
              e.target.style.borderColor = 'var(--system-secondary)';
              e.target.style.boxShadow = '0 0 0 4px rgba(201, 169, 106, 0.12)';
            }
          }}
          onBlur={(e) => {
      ...
      <div
        style={{
          ...
          background: errors.certificate_image
            ...
            : 'linear-gradient(135deg, rgba(201, 169, 106,0.55), rgba(254,185,84,0.55) 55%, rgba(14,165,233,0.45))',
          boxShadow: errors.certificate_image
            ? '0 14px 36px rgba(220, 53, 69, 0.16)'
            : '0 14px 36px rgba(201, 169, 106, 0.14)',
        }}
      ...
      >
        <div
          style={{
            padding: 20,
            borderRadius: 17,
            background: 'linear-gradient(165deg, #ffffff 0%, var(--system-surface) 60%, #fffbeb 140%)',
          }}
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div
              style={{
                ...
                height: 48,
                borderRadius: 14,
                background: 'linear-gradient(145deg, var(--system-secondary), #0ea5e9)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                boxShadow: '0 10px 22px rgba(201, 169, 106, 0.35)',
                flexShrink: 0,
              }}
            >
              ...
              style={{
                border: errors.certificate_image
                  ...
                  : dragOver
                    ...
                    : '2px dashed rgba(201, 169, 106, 0.35)',
                borderRadius: 16,
                padding: '44px 22px',
                textAlign: 'center',
                cursor: 'pointer',
                background: dragOver
                  ...
                  : 'linear-gradient(160deg, #ffffff 0%, var(--system-surface) 100%)',
                boxShadow: dragOver
                  ? '0 0 0 4px rgba(201, 169, 106, 0.14), inset 0 1px 0 rgba(255,255,255,0.9)'
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 20,
                  background: dragOver
                    ? 'linear-gradient(145deg, var(--system-secondary), #0ea5e9)'
                    : 'linear-gradient(145deg, rgba(201, 169, 106,0.12), rgba(254,185,84,0.14))',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: dragOver
                    ? '0 12px 24px rgba(201, 169, 106, 0.35)'
              ...
              <div
                style={{
                  ...
                  padding: '10px 16px',
                  borderRadius: 12,
                  background: 'linear-gradient(135deg, var(--system-secondary), #0ea5e9)',
                  color: '#fff',
                  fontWeight: 800,
                  fontSize: '0.88rem',
                  boxShadow: '0 10px 20px rgba(201, 169, 106, 0.28)',
                }}
              >
                Browse files
              </div>
              ...
              <div style={{ width: '100%', height: 12, backgroundColor: '#e0f2fe', borderRadius: 999, overflow: 'hidden' }}>
                <div
                  style={{
                    ...
                    height: '100%',
                    background: 'linear-gradient(90deg, var(--system-secondary), #38bdf8, #feb954)',
                    borderRadius: 999,
                    transition: 'width 0.2s ease',
                    boxShadow: '0 0 12px rgba(201, 169, 106, 0.45)',
                  }}
                />
              </div>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 800,
                  cursor: 'pointer',
                  boxShadow: '0 8px 18px rgba(201, 169, 106, 0.3)',
                }}
              >
                Try again
              </button>
        ...
        <>
          ...
          {previewSrc && (
            ...
            >
              <div
                style={{
                  padding: '10px 14px',
                  background: 'linear-gradient(90deg, rgba(201, 169, 106,0.25), rgba(254,185,84,0.2))',
                  color: '#e2e8f0',
                  fontSize: '0.82rem',
                  fontWeight: 700,
                }}
                ...
                {dragging && centerGuides.vertical && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: '0 0 0 1px rgba(201, 169, 106, 0.35)',
                      pointerEvents: 'none',
                      zIndex: 3,
                  ...
                  previewPath ? (
                    ...
                    >
                      <path
                        ...
                        style={{
                          pointerEvents: 'auto',
                          filter: dragging
                            ? 'drop-shadow(0 0 2px rgba(201, 169, 106,0.8))'
                    ...
                    <div
                      ...
                      style={{
                        ...
                        padding: '2px 6px',
                        borderRadius: 6,
                        background: dragging ? 'rgba(201, 169, 106,0.18)' : 'transparent',
                        border: dragging ? '1px dashed rgba(201, 169, 106,0.7)' : '1px dashed transparent',
                        zIndex: 4,
                      }}
                    >
                      Student Name
          ...
          <div
            style={{
              ...
              padding: 22,
              borderRadius: 16,
              background: 'linear-gradient(165deg, #ffffff 0%, var(--system-surface) 55%, #fff7ed 140%)',
