...
export function SessionTable({ 
  ...
  const rows = data.map((student) => (
    <Table.Tr key={student.id}>
      <Table.Td style={{ fontWeight: 'bold', color: 'var(--system-secondary)', width: '60px', minWidth: '60px', textAlign: 'center', fontSize: '15px' }}>{student.id}</Table.Td>
      ...
      <Table.Td style={{ textAlign: 'center', width: '140px', minWidth: '140px', fontSize: '15px', fontWeight: '600', color: (() => {
        ...
        return 'var(--system-secondary)'; // blue (>= 9)
      })() }}>
        {student.payment?.numberOfSessions !== null && student.payment?.numberOfSessions !== undefined ? student.payment.numberOfSessions : 0}
      </Table.Td>
      )}
      {showScore && (
        <Table.Td style={{ textAlign: 'center', width: '100px', minWidth: '100px', fontSize: '15px', fontWeight: '600', color: 'var(--system-secondary)' }}>
      ...
      <Table.Td style={{ textAlign: 'center', width: '200px', minWidth: '200px', cursor: 'pointer', fontWeight: 700, color: 'var(--system-secondary)', fontSize: '15px' }}
